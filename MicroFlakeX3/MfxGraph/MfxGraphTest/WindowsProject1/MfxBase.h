...
#ifdef UNICODE
#define __MStr(str) L##str
#define __MfxStr MfxStrW;

#elif 
#define __MStr(str) str
#define __MfxStr MfxStrW;

#endif

#define MStr(str) __MStr(str)
#define MfxStr __MfxStr;
}
...
#define __MfxObject_Init_2(obj, father) \
	...
	{\
		ret = father::AutoFunc(MStr("AutoFunc"), setFunc, argc); \
	}\
	return ret;\
}
